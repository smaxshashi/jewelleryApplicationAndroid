...
import com.bansalandsons.JewellaryApplication.Adapterclasses.AdpterGoldSlider;
...
public class GoldFulldetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences preferences1= PreferenceManager.getDefaultSharedPreferences(GoldFulldetails.this);
        strsubcategorycode=preferences1.getString("subcategorycode","");
    ...
    private void setupImageSlider(List<String> imageUrls) {
        AdpterGoldSlider adapter=new AdpterGoldSlider(GoldFulldetails.this,imageUrls);
    ...
    private void showLoginAlertDialog() {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Log In", (dialog, which) -> {
                    ...
                    Intent intent = new Intent(GoldFulldetails.this, LoginActivity.class);
                    startActivity(intent);
                })
