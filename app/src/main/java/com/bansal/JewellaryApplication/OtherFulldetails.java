...
import com.bansal.JewellaryApplication.Adapterclasses.AdpterDiamondSlider;
import com.bansal.JewellaryApplication.Adapterclasses.Adpterotherslider;
...
public class OtherFulldetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_other_fulldetails);
        getWindow().setNavigationBarColor(ContextCompat.getColor(OtherFulldetails.this,R.color.white));
        getWindow().setStatusBarColor(ContextCompat.getColor(OtherFulldetails.this,R.color.maroon));
        preferences= PreferenceManager.getDefaultSharedPreferences(OtherFulldetails.this);
    ...
    private void setupImageSlider(List<String> imageUrls) {
        Adpterotherslider adapter=new Adpterotherslider(OtherFulldetails.this,imageUrls);
    ...
    private void showLoginAlertDialog() {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Log In", (dialog, which) -> {
                    ...
                    Intent intent = new Intent(OtherFulldetails.this, LoginActivity.class);
                    startActivity(intent);
                })
