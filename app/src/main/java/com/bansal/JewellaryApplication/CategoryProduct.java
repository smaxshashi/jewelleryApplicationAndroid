...
public class CategoryProduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setNavigationBarColor(ContextCompat.getColor(CategoryProduct.this,R.color.white));
        getWindow().setStatusBarColor(ContextCompat.getColor(CategoryProduct.this,R.color.maroon));
        AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_NO);
        SharedPreferences preferences1= PreferenceManager.getDefaultSharedPreferences(CategoryProduct.this);
        strCategoryId=preferences1.getString("NoCategory","");
    ...
    private void setupImageSlider(List<String> imageUrls) {
        GiftingSlider adapter = new GiftingSlider(CategoryProduct.this, imageUrls);
    ...
    private void showLoginAlertDialog() {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Log In", (dialog, which) -> {
                    ...
                    Intent intent = new Intent(CategoryProduct.this, LoginActivity.class);
                    startActivity(intent);
                })
